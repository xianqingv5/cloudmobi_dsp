...
class DemandOfferService extends BaseService
{
    ...
    public static function formatData($data)
    {
        ...
        foreach ($data as $k=>$v) {
            ...
            $res[$k]['id'] = $v['channel'] . '_' . Yii::$app->params['OFFER_ID_STRING'] . str_pad( $v['id'], 3, 0, STR_PAD_LEFT );
            ...
            $res[$k]['specific_device'] = !empty($v['specific_device']) ? json_decode($v['specific_device'], true) : [];
