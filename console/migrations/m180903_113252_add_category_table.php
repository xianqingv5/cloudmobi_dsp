...
/**
 * Class m180903_113252_add_category_table
 */
class m180903_113252_add_category_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        if ($this->db->driverName === 'mysql') {
            ...
            $table_options = 'CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE=InnoDB COMMENT \'android category\'';
        }

        $this->createTable('{{%android_category}}', [
    ...
    {
        echo "m180903_113252_add_category_table cannot be reverted.\n";
