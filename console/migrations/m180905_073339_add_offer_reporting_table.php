...
class m180905_073339_add_offer_reporting_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%offer_reporting}}', [
            'day' => $this->date()->notNull()->defaultValue('1000-01-01')->comment('日期'),
            ...
            'country_id' => $this->integer(11)->notNull()->defaultValue(0)->comment('国家'),
        ...
        $this->createIndex('reporting', '{{%offer_reporting}}', ['day','campaign_owner','offer_id','country_id','platform'], true);
    }
